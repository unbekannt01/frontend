    ...
    <StyledDashboard>
      <NavBar>
        ...
        <ButtonGroup>
          ...
          <ChangePasswordButton onClick={() => setShowPasswordModal(true)}>Change Password</ChangePasswordButton>
      ...
      <Content>
        <ProfileCard>
          {user.avatar ? (
            <Avatar src={`http://localhost:3001/uploads/${user.avatar}`} alt="User Profile" />
          ) : (
            <AvatarPlaceholder>
              {user.first_name?.[0]}
              {user.last_name?.[0]}
          ...
          <ModalContent>
            ...
            <ModalBody>
              <form onSubmit={handlePasswordSubmit}>
                ...
                {passwordMessage && (
                  <Message success={passwordMessage.includes("Successfully")}>{passwordMessage}</Message>
                )}
                <ButtonGroup>
